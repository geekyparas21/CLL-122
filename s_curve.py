...
class IgnitionExtinctionCurve2(Scene):
    def construct(self):
        ...
        # Define points on the S-curve
        points = [
            axes.coords_to_point(1, 1),        # 1
            axes.coords_to_point(2, 5/4),      # 2
            axes.coords_to_point(2, 3),        # 3
            axes.coords_to_point(3, 1.5),      # 4
            axes.coords_to_point(3, 2.4),      # 5 (unstable)
            axes.coords_to_point(3, 13/4),     # 6
            axes.coords_to_point(4, 7/4),      # 7
            axes.coords_to_point(4, 15/7),     # 8
            axes.coords_to_point(4, 3.5),      # 9
            axes.coords_to_point(5, 2),        # 10
            axes.coords_to_point(5, 15/4),     # 11
            axes.coords_to_point(6, 4),        # 12
        ]
        ...
        # Group everything (except legend) to shift upward
        plot_group = VGroup(
